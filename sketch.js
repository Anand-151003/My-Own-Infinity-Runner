...
var flag = 0;
function preload() {
 // trex_running = loadAnimation("3.png");
  //trex_collided = loadImage("trex_collided.png");
 trex_running = loadAnimation("6.png");
 trex_collided = loadImage("6.png");
  groundImage = loadImage("ground2.png");
  cloudImage = loadImage("cloud.png");

  //obstacle1 = loadImage("obstacle1.png");
  obstacle1 = loadImage("7.jpg");

//  obstacle2 = loadImage("obstacle2.png");
  obstacle2 = loadImage("8.png");

  //obstacle3 = loadImage("obstacle3.png");
  obstacle3 = loadImage("7.jpg");

  //obstacle4 = loadImage("obstacle4.png");
  obstacle4 = loadImage("10.png");

  //obstacle5 = loadImage("obstacle5.png");
  obstacle5 = loadImage("10.png");

  //obstacle6 = loadImage("obstacle6.png");
  obstacle6 = loadImage("8.png");
